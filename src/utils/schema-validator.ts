...
function schemaImpliesObject(schema: SimpleSchema): boolean {
...
function validateEnum(value: unknown, schema: SimpleSchema, path: string): void {
  if (!schema.enum) {
    return;
  }
